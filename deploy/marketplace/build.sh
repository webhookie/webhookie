...
# PRODUCT_NAME=webhookie
# PRODUCT_VERSION=1.0.0
# AWS_REGION=ap-southeast-2
#
#
# PRODUCT_CODE=8q8unok6ionf0rkah7ct8fsvy
# ECR_REPOSITORY=358992842910.dkr.ecr.ap-southeast-2.amazonaws.com/webhookie
...
function clean_up() {
  echo -e "\e[32mCleaning up\e[0m"
  	...
  	helm uninstall ${PRODUCT_NAME}ic
	sleep 30
#  	aws dynamodb delete-table --table-name ${PRODUCT_NAME}DimensionsTable
	...
	eksctl delete cluster -f ./${PRODUCT_NAME}-cluster.yaml
}
